...
public class EBBRegisterAllocator {
    ...
    private class EBBIRHandler extends IRHandler {
    ...
    private EBBIRHandler irHandler;


    public EBBRegisterAllocator(String path) {
        this.path = path;
        this.irHandler = new EBBIRHandler();
        this.output = "";
    }
    ...
    public void generate() throws Exception {
        ...
        while (funcStream != null) {
            ...
            HashMap<String, IGNode> interferenceGraphHelper = new HashMap<String, IGNode>();

            // Populate helper with nodes.
            for (Map.Entry<String,HashSet<String>> entry : EBBWeb.web.entrySet()) {
                String var = entry.getKey();
                interferenceGraphHelper.put(var, new IGNode(var));
            }
            ...
            for (Map.Entry<String,HashSet<String>> entry : EBBWeb.web.entrySet()) {
                ...
                for (String child : children) {
                    interferenceGraphHelper.get(var).children.add(interferenceGraphHelper.get(child));
                }
            }
